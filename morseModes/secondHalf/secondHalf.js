...
let availableMorseList = ['- o','- - -','o - - o','- - o -','o - o','o o o','-','o o -','o o o -','o - -','- o o -','- o - -','- - o o'];
let matchLettersList = ['N','O','P','Q','R','S','T','U','V','W','X','Y','Z'];
let poolLettersList = ['N','O','P','Q','R','S','T','U','V','W','X','Y','Z'];
